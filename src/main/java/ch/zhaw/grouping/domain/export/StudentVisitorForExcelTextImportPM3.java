...
public class StudentVisitorForExcelTextImportPM3 extends StudentVisitorAbstract {
	private StringBuilder target;
	private int lineNbr;
	private int groupLineNbr;

	public StudentVisitorForExcelTextImportPM3() {
		super();
		this.target = new StringBuilder();
	}

	public StudentVisitorForExcelTextImportPM3(StringBuilder target) {
		super();
		this.target = target;
	}
	...
	public void visitModulExecution(ModulExecution execution) {
		...
		target.append("\t\t\tPL\tPS Technik\tPS Sprache")
		     //        g              h         i               j
			.append("\tL-Architektur\tM3\tTB II Technik\tTB II Sprache")
			//         k     l           m           n     o
	...
	public static void printGroupsToExcelFile(String excelImportFile, ModulExecution modul){
		if (excelImportFile != null){
			StudentVisitorForExcelTextImportPM3 visitor = new StudentVisitorForExcelTextImportPM3();
